...
if($display == 1)
{
    ...
    require ModuleHelper::getLayoutPath('mod_db8kivateam', $params->get('layout', 'team'));

}
elseif($display == 2)
{
    $lenders = modDB8KivaTeamHelper::getLenders($params);
    require ModuleHelper::getLayoutPath('mod_db8kivateam', $params->get('layout', 'lenders'));

}
elseif($display == 3)
{
    $loans = modDB8KivaTeamHelper::getLoans($params);
    require ModuleHelper::getLayoutPath('mod_db8kivateam', $params->get('layout', 'loans'));
}